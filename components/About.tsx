...
function About({ pageInfo }: Props) {
  return (
    ...
    className='flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 
    h-screen justify-evenly mx-auto items-center'>
       ...
       md:rounded-lg md:w-64 md:h-96 xl:w-[500px] xl:h-[600px] object-cover'
       />
